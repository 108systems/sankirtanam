...
To run:
 - Install Anaconda python distribution, miniconda is ok
 - Install missing packages, langchain, etc. (TODO: create file with dependencies)
 - Download sql db file with SP books
 - Download llama cpp gguf file
